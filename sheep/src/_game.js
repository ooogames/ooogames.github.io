...
var Sheep = function(){
	...
	var matmuseau = new THREE.MeshPhongMaterial({color:Colors.brownDark, shading:THREE.FlatShading});
	...
	// pieds du mouton
	var geompied = new THREE.BoxGeometry(5,5,5,1,1,1);
	var matpied = new THREE.MeshPhongMaterial({color:Colors.brownDark, shading:THREE.FlatShading});
	var pied = new THREE.Mesh(geompied, matpied);
	pied.position.set(5,12,0);
...
Sea = function(){
	var geom = new THREE.SphereBufferGeometry(game.seaRadius,12,12);
